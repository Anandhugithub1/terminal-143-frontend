...
// Updated CirclesHomePage.jsx - Fix the myCircles data to include all required fields
const myCircles = [
  {
    id: 1,
    name: "Running",
  ...
  },
  {
    ...
    members: 86,
    onlineMembers: 12,
    description: "Practice languages with native speakers. English, Thai, Japanese, Korean and more!",
    image: "https://images.unsplash.com/photo-1546410531-bb4caa6b424d?w=100&h=100&fit=crop",
    coverImage: "https://images.unsplash.com/photo-1546410531-bb4caa6b424d?w=800&h=400&fit=crop",
    bgColor: "bg-blue-50",
    category: "Learning & Education",
    createdDate: "March 2024",
    location: "Bangkok, Thailand",
    tags: ["Languages", "Culture", "Exchange", "Learning"],
    rules: [
  ...
  },
  {
    ...
    members: 210,
    onlineMembers: 45,
    description: "Connect with fellow gamers! PC, console, mobile - all platforms welcome.",
    ...
    location: "Online",
    tags: ["Gaming", "Esports", "Multiplayer", "Casual"],
    rules: [
      "No toxic behavior",
      "Be a good teammate",
  ...
  },
  {
    ...
    members: 64,
    onlineMembers: 8,
    description: "Share your photos, learn techniques, and explore Bangkok through your lens.",
    ...
    location: "Bangkok, Thailand",
    tags: ["Photography", "Art", "Photo Walks", "Tutorials"],
    rules: [
  ...
  },
  {
    ...
    members: 51,
    onlineMembers: 6,
    description: "Discover new music, share playlists, and connect with musicians.",
    ...
    location: "Bangkok, Thailand",
    tags: ["Music", "Concerts", "Instruments", "Playlists"],
    rules: [
      "Share music respectfully",
