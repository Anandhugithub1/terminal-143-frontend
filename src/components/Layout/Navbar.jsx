        ...
        <div className="flex justify-between h-16 items-center">
          ...
          <Link to="/" className="flex-shrink-0 flex items-center">
            <div className="bg-gradient-to-r from-gradient-primary to-gradient-secondary p-2 rounded-lg">
              <HeartIcon className="w-6 h-6 text-white" aria-hidden="true" />
            </div>
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            <div className="relative lang-selector">
              ...
              {langMenuOpen && (
                <div className="absolute right-0 mt-2 w-48 bg-white border border-gray-200 rounded-xl shadow-xl p-1 z-50 animate-in fade-in zoom-in-95 duration-150">
                  {otherLanguages.map(lang => (
                    <button
                      ...
                      className="w-full flex items-center gap-3 px-3 py-2.5 text-sm font-medium text-gray-700 rounded-lg hover:bg-indigo-50 hover:text-indigo-600 active:scale-95 transition-all duration-150"
                    >
                      <ReactCountryFlag
                        svg
          ...
          <div className="flex items-center space-x-2 md:hidden">
            ...
            <div className="relative mobile-lang-selector">
              <button
                ...
                className="flex items-center gap-2 px-3 py-2 rounded-lg text-gray-700 text-sm font-medium hover:bg-gray-100 active:scale-95 transition-all duration-150"
              >
                <ReactCountryFlag
                  svg
                  countryCode={selectedLang.countryCode}
              ...
              {mobileLangOpen && (
                <div className="absolute right-0 mt-2 w-56 bg-white border border-gray-200 rounded-xl shadow-xl p-2 z-50">
                  {LANGUAGES.map(lang => (
                    <button
                      key={lang.code}
                      aria-label={`Switch to ${lang.label}`}
