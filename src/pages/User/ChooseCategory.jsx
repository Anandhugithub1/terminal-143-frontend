...
import womanInRedShirt from '../../assets/man.png';
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4 pb-8">
        ...
        <div className="w-full max-w-md sm:max-w-lg space-y-4 sm:space-y-6">
          ...
          <div
            ...
            className={`relative rounded-2xl shadow-lg p-5 sm:p-8 flex flex-row items-center justify-between gap-4
          ...
          >
            ...
            {/* Woman Image */}
            <div className="relative z-10 w-24 h-24 sm:w-32 sm:h-32 flex-shrink-0">
              <img
                src={womanInRedShirt}
                alt="Match Provider"
