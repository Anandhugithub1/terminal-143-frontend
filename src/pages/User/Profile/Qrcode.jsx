    ...
    <main className="flex-grow flex items-center justify-center px-4 py-8">
      {status === 'loading' && (
        <div className="animate-pulse space-y-6 w-full max-w-sm">
          <div className="h-8 bg-pink-100 rounded-full w-2/3 mx-auto"></div>
          <div className="h-64 bg-pink-100 rounded-2xl mx-auto"></div>
          <div className="h-12 bg-pink-100 rounded-full mx-auto"></div>
        </div>
      )}
      ...
      {status === 'succeeded' && (
        ...
        >
          <div className="text-center space-y-2">
            {/* <Heart className="mx-auto text-pink-600 fill-current" size={32} /> */}
